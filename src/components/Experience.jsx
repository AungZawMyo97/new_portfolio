...
import { Box, Container, Heading, Text, VStack, HStack, Icon, useColorMode, Flex, Badge, Circle } from '@chakra-ui/react';
import { FaBriefcase, FaCalendarAlt, FaLaptopCode } from 'react-icons/fa';
import experienceData from '../data/experience.json';

const Experience = () => {
    const { colorMode } = useColorMode();
    const { summary, experience } = experienceData;
                ...
                <VStack spacing={4} mb={16} textAlign="center">
                    ...
                    >
                        ...
                        <Text
                            ...
                            maxW="600px"
                        >
                            {summary.years} {summary.title}. {summary.description}
                        </Text>
                    </motion.div>
                </VStack>
                    ...
                    <VStack spacing={12} align="stretch">
                        {experience.map((job, index) => (
                            ...
                            >
                                ...
                                <Box w={{ base: '0', md: '45%' }} display={{ base: 'none', md: 'block' }} />
                            </Flex>
                        ))}
                    </VStack>
                </Box>
