...
import { Box, Container, Heading, Text, VStack, HStack, Icon, useColorMode, Image, Flex, Stack, Tooltip, Badge } from '@chakra-ui/react';
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                aka <Text as="span" fontWeight="bold" color="#FF0080">Oppai The Original</Text>
              </Text>
            </motion.div>
            ...
            >
              <Text
                ...
                lineHeight="1.8"
              >
                A passionate <Text as="span" color="#7928CA" fontWeight="bold">Full Stack Developer</Text> and <Text as="span" color="#FF0080" fontWeight="bold">Content Creator</Text> crafting digital experiences that merge technical precision with creative entertainment.
              </Text>
            </motion.div>
            ...
            >
              <HStack spacing={4} pt={4} flexWrap="wrap" justify={{ base: 'center', lg: 'flex-start' }}>
                {[
                  { icon: FaGithub, href: "https://github.com/aungzawmyo", color: "#ffffff", label: "Github" },
                  { icon: FaYoutube, href: "https://youtube.com/@original_oppai", color: "#FF0000", label: "YouTube" },
                  { icon: FaTwitch, href: "https://twitch.tv/oppaitheoriginal", color: "#9146FF", label: "Twitch" }
                ].map((social, idx) => (
                  <Tooltip key={idx} label={social.label} hasArrow bg="gray.700">
                    <motion.a
                      href={social.href}
                      target="_blank"
                      rel="noreferrer"
                      ...
                      style={{
                        padding: '16px',
                        background: colorMode === 'dark' ? 'rgba(255,255,255,0.05)' : 'white',
                        borderRadius: '16px',
                        border: '1px solid',
                        borderColor: colorMode === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.05)',
                    ...
                    >
                      <Icon as={social.icon} w={6} h={6} color={colorMode === 'dark' ? "gray.400" : "gray.600"} _hover={{ color: social.color }} transition="color 0.2s" />
                    </motion.a>
                  </Tooltip>
                ))}
              </HStack>
          ...
          <Box flex={1} position="relative" display="flex" justifyContent="center">
            ...
            >
              ...
              >
                ...
                <Image
                  ...
                  objectFit="cover"
                  filter={colorMode === 'dark' ? 'brightness(1.1)' : 'contrast(1.1)'}
                />
              </Box>
            </motion.div>
            ...
            >
              <Icon as={FaGamepad} w={10} h={10} color="#FF0080" opacity="0.8" filter="drop-shadow(0 0 10px #FF0080)" />
            </motion.div>
          </Box>
        </Stack>
